...
# GMcCaslin,1.5.2030,Created Script
# ------------------------------------------------------------------------------------------------- #
...
class Person:
    ...
    ChangeLog:
    - GMcCaslin, 3.3.2025: Created the class.
    """
    ...
    def first_name(self, value: str):
        ...
        """
        Defines a setter method for the first_name attribute, ensuring that it
        only contains alphabetic characters or is empty; otherwise, it raises 
        a ValueError.
        """
    ...
    """
    defines a read-only property last_name that returns the value of 
    self.__last_name with the first letter of each word capitalized 
    using .title()
    """
    ...
    def last_name(self, value: str):
        ...
        """
        Defines a getter method for the last_name attribute using the 
        @property decorator, ensuring that when accessed, it returns the 
        last name in title case (first letter capitalized)
        """
    ...
    formatting it as "first_name,last_name".
    """
...
class Employee(Person):
    ...
    def __init__(self, first_name: str = "", last_name: str = "", review_date: str = "1900-01-01", review_rating: int = 3):
        ...
        """
        A constructor method (__init__) that initializes an object with 
        a first name, last name, review date, and review rating, while also 
        calling the parent class’s initializer using super().
        """
    ...
    """
    Defines a read-only property review_date that returns the value of 
    the private attribute __review_date.
    """
    ...
    def review_date(self, value: str):
        ...
        """
        Defines a setter method for the review_date property, 
        ensuring that any assigned value is in the correct YYYY-MM-DD 
        format by attempting to convert it using date.fromisoformat(value), 
        and raising a ValueError if the format is incorrect.
        """
    ...
    """
    Defines a property method review_rating that returns the value 
    of the private attribute __review_rating.
    """
    ...
    def review_rating(self, value: int):
        ...
        only integer values between 1 and 5 can be assigned, and raises a ValueError 
    ...
    """
    The __str__ method returns a formatted string representation of an object, 
    displaying the first_name, last_name, review_date, and __review_rating attributes.
    """
...
class FileProcessor:
    ...
    ChangeLog: (Who, When, What)
    GMcCaslin,3.3.2025,Created Class
    """
    ...
    def read_employee_data_from_file(file_name: str, employee_data: list, employee_type: Employee):
        ...
        ChangeLog: (Who, When, What)
        GMcCaslin,3.3.2025,Created function
...
class IO:
    ...
    def output_error_messages(message: str, error: Exception = None):
        ...
        ChangeLog: (Who, When, What)
        GMcCaslin,1.3.2030,Created function
    ...
    def output_employee_data(employee_data: list):
        ...
        for employee in employee_data:
            if employee.review_rating == 5:
                message = "{} {} (Reviewed on: {}) is rated as 5 (Leading)"
            elif employee.review_rating == 4:
                message = "{} {} (Reviewed on: {}) is rated as 4 (Strong)"
            elif employee.review_rating == 3:
                message = "{} {} (Reviewed on: {}) is rated as 3 (Solid)"
            elif employee.review_rating == 2:
                message = "{} {} (Reviewed on: {}) is rated as 2 (Building)"
            elif employee.review_rating == 1:
                message = "{} {} (Reviewed on: {}) is rated as 1 (Not Meeting Expectations)"
    ...
    def input_employee_data(employee_data: list, employee_type: Employee):
        ...
        try:
            ...
            employee_object.review_rating = int(input("What is their review rating? "))  # Ensure integer conversion
            employee_data.append(employee_object)
